        ...
        <form action="Admin-MenuEdit-Pro.php?id=<?=$pid?>" method="POST" class="m-auto" enctype="multipart/form-data">
            <div class="row g-3 m-auto justify-content-center">
                <div class="col">
                    ...
                    <input class="form-control pe-md-5" type="text" placeholder="ชื่อเมนู" required name="Menu_name" id="inputMenu1" value="<?= $data['Menu_name'] ?>">
                </div>
                <div class="col">
                    <label for="Menu_Mat" class="form-label">ส่วนประกอบ</label>
                    <textarea class="form-control " id="txtarea" placeholder="ส่วนประกอบ" name="Menu_Mat1" required><?= $data['Menu_Mat1'] ?></textarea>
                    <script>
            ...
            <div class="row g-3 m-auto justify-content-center">
                <div class="col">
                    ...
                    <textarea class="form-control" id="txtarea1" name="Menu_How1" placeholder="วิธีทำ" required><?= $data['Menu_How1'] ?></textarea>
                    <script>
                        function expandTextarea(id) {
                            document.getElementById(id).addEventListener('keyup', function() {
                                this.style.overflow = 'hidden';
                        ...
                        expandTextarea('txtarea1');
                    </script>
                </div>
                <div class="col">
                    <label for="Menu_Mat" class="form-label">คำอธิบาย</label>
                    <textarea class="form-control " id="txtarea2" placeholder="คำอธิบาย" name="Menu_EP" required><?= $data['Menu_EP'] ?></textarea>
                    <script>
                        function expandTextarea(id) {
                            document.getElementById(id).addEventListener('keyup', function() {
                                this.style.overflow = 'hidden';
            ...
            <div>
                <div class="row g-5 justify-content-center m-auto pt-4 col-11">
                    <div class="IMG-Input col m-3">
                        ...
                        <input class="form-control" type="text" name="Img_URL_Main" id="image-url-main" placeholder="Enter image URL" oninput="preview('main')" required value="<?php
                    ...
                    <div class="IMG-Input col m-3">
                        ...
                        <p class="text-danger">**ถ้าภาพไม่ขึ้นให้เปลี่ยนภาพ ถ้าลิงก์ไม่มี https ให้เปลี่ยนลิงก์ ถ้าลิงก์ขึ้นต้น data:image/ ให้เปลี่ยนลิงก์**</p>
                        <input class="form-control" type="text" name="Image_URL_Sec1" id="image-url-sec1" placeholder="Enter image URL" oninput="preview('sec1')" required value="<?php
                    ...
                    <div class="IMG-Input col m-3">
                        ...
                        <p class="text-danger">**ถ้าภาพไม่ขึ้นให้เปลี่ยนภาพ ถ้าลิงก์ไม่มี https ให้เปลี่ยนลิงก์ ถ้าลิงก์ขึ้นต้น data:image/ ให้เปลี่ยนลิงก์**</p>
                        <input class="form-control" type="text" name="Image_URL_Sec2" id="image-url-sec2" placeholder="Enter image URL" oninput="preview('sec2')" required value="<?php
                ...
                <div class="row g-5 justify-content-center m-auto pt-4 col-11">
                    <div class="IMG-Input col m-3">
                        ...
                        <p class="text-danger">**ถ้าภาพไม่ขึ้นให้เปลี่ยนภาพ ถ้าลิงก์ไม่มี https ให้เปลี่ยนลิงก์ ถ้าลิงก์ขึ้นต้น data:image/ ให้เปลี่ยนลิงก์**</p>
                        <input class="form-control" type="text" name="Image_URL_Sec3" id="image-url-sec3" placeholder="Enter image URL" oninput="preview('sec3')" required value="<?php
