...
<header>
    <div class="logo-1">
        ...
        <li class="nav">
            ...
            <a href="../LoginPAGE/login.php" class="Active">Login</a>
            ...
            <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1 mt-5">
                <form action="../cklogin.php" method="POST" >
                    ...
                    <div class="divider d-flex align-items-center my-4">
                        <p class="text-center fw-bold mx-3 mb-0">Account</p>
                    </div>

                    <!-- Email input -->
                    <div class="form-outline mb-4">
                        <input required name="username" type="text" id="form3Example3" class="form-control form-control-lg" placeholder="Username or Email" />
                    ...
                    <div class="text-center text-lg-start mt-4 pt-2">
                        ...
                        <p class="small fw-bold mt-2 pt-1 mb-0">ถ้าไม่มีบัญชี กดตรงนี้เพื่อสมัคร<a href="../Regis.php" class="link-danger">Register</a></p>
                    </div>
                </form>
            </div>
        </div>
